...
<main>
    ...
    <div class="container bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        <header
            ...
            <div class="col-md-3 text-end">
                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                    <a href="{{ route('login') }}" role="button" class="btn btn-outline-primary btn-sm me-2">Log in</a>
        
                    @if (Route::has('register'))
                    <a href="{{ route('register') }}" role="button" class="btn btn-primary btn-sm">Sign-up</a>
                    @endif
                    @endauth
                </div>
                @endif
    ...
    <div class="container-fluid pb-3">
        <div class="d-grid gap-3" style="grid-template-columns: 1fr 2fr;">
            <div class="bg-light border rounded-3 max-w-6xl mx-auto sm:px-6 lg:px-8">
                <br><br><br><br><br><livewire:counter /><br><br><br><br><br>
            </div>
            <div class="bg-light border rounded-3 max-w-6xl mx-auto sm:px-6 lg:px-8">
